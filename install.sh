...
# @Description     : installer script for mutt
#
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
APP="$APPNAME notmuch-mutt msmtp pass isync mbsync "
PERL=""
PYTH=""
PIPS=""
CPAN=""
...
run_postinst() {
  dfmgr_run_post
  [ -f "$HOME/.mbsyncrc" ] && cmd_exists mbsync && mbsync -Ca || true
}
